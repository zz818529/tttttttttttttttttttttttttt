...
my_channel = Config.MY_CHANNEL or "darkmoonuserbot"
my_group = Config.MY_GROUP or "darkmoonuserbot"
if "@" in my_channel:
    my_channel = my_channel.replace("@", "")
if "@" in my_group:
    my_group = my_group.replace("@", "")

chnl_link = "https://t.me/darkmoonuserbot"
hell_channel = f"[The ᴅᴀʀᴋ ᴍᴏᴏɴ ᴜꜱᴇʀʙᴏᴛ]({chnl_link})"
grp_link = "https://t.me/darkmoonuserbot"
hell_grp = f"[ᴅᴀʀᴋ ᴍᴏᴏɴ ᴜꜱᴇʀʙᴏᴛ Group]({grp_link})"
